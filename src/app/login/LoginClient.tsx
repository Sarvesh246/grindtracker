...
function friendlyLoginError(reason: string): string {
  const known = LOGIN_ERRORS[reason]
...
export default function LoginClient() {
  ...
  useEffect(() => {
    ...
    setError(friendlyLoginError(reason))
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', marginBottom: '48px' }}>
        ...
        >
          Sign in with Google to log workouts, keep your streak, and pick up where you left off.
        </p>
      </div>
