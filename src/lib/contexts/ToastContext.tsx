...
interface ToastAPI {
  /** Flash a brief, swipe-dismissable bottom-anchored pill. Defaults to a
   *  "saved"-style success confirmation; pass 'error' for a failure that needs
   *  to read as visually distinct, not just differently-worded. */
 ...
 * on its own. Swipe it left, right, or up to dismiss early. Mounted once in
 * the (app) layout so any page can call `useToast().show(...)` without wiring
