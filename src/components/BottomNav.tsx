...
const tabs = [
  {
    ...
    icon: (active: boolean) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
        stroke="currentColor"
        strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: active ? 'var(--accent-text)' : 'var(--text-muted)', transition: 'color 150ms ease' }}>
        ...
        return (
          ...
          >
            {/* The active tab's icon lifts and grows a hair. Colour alone is a
                very quiet answer to a tap on a 64px target. */}
            <span style={{
              display: 'flex',
